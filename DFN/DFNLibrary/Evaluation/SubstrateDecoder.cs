...
namespace DFN.Evaluation
{
    public class SubstrateDecoder
    {
        ...
        public static IGenomeDecoder<NeatGenome, IBlackBox> CreateGenomeDecoder(bool normalizeWeight, int pixelWidth, int pixelHeight,
            NetworkActivationScheme cppnSchem, NetworkActivationScheme substrateScheme, bool cppnInputLength, bool biasUsesLEO, bool useLEO)
        {
            ...
            IGenomeDecoder<NeatGenome, IBlackBox> genomeDecoder = new HyperNeatDecoder(substrate, cppnSchem, substrateScheme, cppnInputLength);
