...
namespace SharpNeat.Decoders
{
    ...
    {
        //is this a network where you can access and modify connections or nodes
        bool _isOpenNetwork;
     ...
     //=== Cyclic network specific activation.
        ...
        /// <summary>
        /// Is this an open network? i.e. connections and nodes may be notified
        /// </summary>
        public bool OpenAcyclicNetwork
        {
            get { return _isOpenNetwork; }
        }
        /// <summary>
        ...
        public bool SingleOuputHiddenNetwork
        {
            get;
            set;
        }

        public bool SingleOutputNetwork
        {
            get;
            set;
        }
        ...
        /// <summary>
        /// Create an activation scheme for single output networks -- e.g. features!
        /// </summary>
        public static NetworkActivationScheme CreateSingleOutputScheme()
        {
            NetworkActivationScheme scheme = new NetworkActivationScheme();
            scheme.SingleOutputNetwork = true;
            return scheme;
        }
        ...
        /// Create an activation scheme for single output networks -- e.g. features!
        /// </summary>
        public static NetworkActivationScheme CreateSingleOutputHiddenScheme()
        {
            NetworkActivationScheme scheme = new NetworkActivationScheme();
            scheme.SingleOuputHiddenNetwork = true;
            return scheme;
        }
        ...
        /// </summary>
        public static NetworkActivationScheme CreateAcyclicOpenScheme()
        {
            NetworkActivationScheme scheme = new NetworkActivationScheme();
            scheme._isOpenNetwork = true;
