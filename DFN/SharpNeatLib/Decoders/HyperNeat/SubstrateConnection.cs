...
namespace SharpNeat.Decoders.HyperNeat
{
    ...
    public class SubstrateConnection
    {
        ...
        //DFN: Adding the concept of layers -- this is the index of the output node for the relative weight
        public int _cppnOutputIndex;

        //DFN: Adding the concept of having hidden nodes in the feature connect through layering -- 
        //some layers don't need all the dimensions
        public bool _singleOutput;

        /// <summary>
        /// Constructs with the specified source and target substrate nodes.
        /// </summary>
        public SubstrateConnection(SubstrateNode srcNode, SubstrateNode tgtNode, int cppnOutputIndex, bool singleOutput)
        {
            _srcNode = srcNode;
            _tgtNode = tgtNode;
            _cppnOutputIndex = cppnOutputIndex;
