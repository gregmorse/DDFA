...
namespace SharpNeat.Decoders.HyperNeat
{
    ...
    {
        //DFN Changes: Need to have a layer for any connection between -- the layer is the index of the CPPN output to pull from
        //this is for Justin's Multi-modal changes
        /// <summary>
        ...
        /// </summary>
        IEnumerable<SubstrateConnection> GenerateConnections(int layer, SubstrateNodeSet srcNodeSet, SubstrateNodeSet tgtNodeSet);
        ...
        /// </summary>
        int GetConnectionCountHint(int layer, SubstrateNodeSet srcNodeSet, SubstrateNodeSet tgtNodeSet);
    }
}
