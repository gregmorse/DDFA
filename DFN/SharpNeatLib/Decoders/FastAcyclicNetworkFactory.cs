...
namespace SharpNeat.Decoders
{
    ...
    public class FastAcyclicNetworkFactory
    {
        ...
        /// </summary>
        public static FastAcyclicNetwork CreateFastAcyclicNetwork(INetworkDefinition networkDef, bool isOpen = false)
        {
        ...
        //=== Create array of FastConnection(s). 
            ...
            if (isOpen)
            {
                OpenAcyclicNetwork mp = new OpenAcyclicNetwork(nodeActivationFnArr, nodeAuxArgsArray, fastConnectionArray, layerInfoArr, outputNeuronIdxArr,
                                          nodeCount, networkDef.InputNodeCount, networkDef.OutputNodeCount);

                return (FastAcyclicNetwork)mp;
            }
            else
