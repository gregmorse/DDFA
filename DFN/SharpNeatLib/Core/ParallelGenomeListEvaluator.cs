...
namespace SharpNeat.Core
{
        ...
        where TPhenome : class
    {
        ...
        {
            return _phenomeEvaluator.ReloadImages();
        }
        ...
        private void Evaluate_NonCaching(IList<TGenome> genomeList)
        {
            ...
            Parallel.ForEach(genomeList, _parallelOptions, delegate(TGenome genome)
            {
                    ...
                    else
                    {
                        ...
                        //DFN: Modified to set novelty behavior
                        genome.EvaluationInfo.SetBehavior(fitnessInfo._novelty);
                        //DFN-Paul: could be null -- set it anyways -- cheap call
                        genome.EvaluationInfo.SetSecondBehavior(fitnessInfo._secondBehavior);
                        genome.EvaluationInfo.AuxFitnessArr = fitnessInfo._auxFitnessArr;
                        genome.EvaluationInfo.SetBinaryActivation(fitnessInfo._binaryActivation);
        ...
        private void Evaluate_Caching(IList<TGenome> genomeList)
        {
            ...
            //foreach(TGenome genome in genomeList)
            {
                    ...
                    else
                    {
                        FitnessInfo fitnessInfo = _phenomeEvaluator.Evaluate(phenome);
                        genome.EvaluationInfo.SetFitness(fitnessInfo._fitness);
                        //DFN: Modified to set novelty behavior array
                        genome.EvaluationInfo.SetBehavior(fitnessInfo._novelty);
                        //DFN-Paul: could be null -- set it anyways -- cheap call
                        genome.EvaluationInfo.SetSecondBehavior(fitnessInfo._secondBehavior);
                        genome.EvaluationInfo.AuxFitnessArr = fitnessInfo._auxFitnessArr;
